...
<script module lang="ts">
  ...
  import type { DialogState } from "$lib/shared/states.ts";
...
<script lang="ts">
  ...
  import { useFloatingDismissable } from "$lib/shared/hooks.ts";
  ...
  const dismissable = useFloatingDismissable(context);
</script>
