  ...
  export const createButtonStyle = cva(
    ...
    ],
    {
      variants: {
        variant: {
          solid: [
            "bg-foreground-500 text-white",
            "inset-shadow-xs inset-shadow-foreground-800/40",
            "ring-1 ring-inset ring-foreground-800/20 dark:ring-foreground-100/20",
            "bg-linear-to-br from-transparent to-foreground-600",
            "hover:(bg-foreground-400 dark:bg-foreground-600)",
