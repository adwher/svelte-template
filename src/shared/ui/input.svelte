...
<script lang="ts">
  ...
  const inputStyle = $derived(createInputStyle({ fullwidth, class: props.class }));
</script>

<input {...props} class={inputStyle} bind:value />
