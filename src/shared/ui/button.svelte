...
<script module lang="ts">
  ...
  export const createButtonStyle = cva(
    [
      ...
      "h-9 px-3 gap-2 text-base tracking-tight font-serif font-350 rounded-lg",
    ...
    ],
    {
      variants: {
        variant: {
          ...
          surface: [
            "bg-foreground-400/10 text-foreground-800 dark:text-foreground-100",
            "ring-1 ring-inset ring-foreground-800/20 dark:ring-foreground-100/20",
            "hover:(bg-foreground-400/20)",
